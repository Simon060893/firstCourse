...
public class Action extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		g.fillRect(defender.getTankX(), defender.getTankY(), 64, 64);

		g.setColor(new Color(0, 255, 0));
		if (defender.getDirection().getId() == 1) {
			g.fillRect(defender.getTankX() + 20, defender.getTankY(), 24, 34);
		} else if (defender.getDirection().getId() == 2) {
			g.fillRect(defender.getTankX() + 20, defender.getTankY() + 30, 24,
					34);
		} else if (defender.getDirection().getId() == 3) {
			g.fillRect(defender.getTankX(), defender.getTankY() + 20, 34, 24);
		} else {
			g.fillRect(defender.getTankX() + 30, defender.getTankY() + 20, 34,
					24);
		}
		// agressor
		g.setColor(new Color(255, 255, 0));
		g.fillRect(agressor.getTankX(), agressor.getTankY(), 64, 64);

		g.setColor(new Color(255, 0, 255));
		if (agressor.getDirection().getId() == 1) {
			g.fillRect(agressor.getTankX() + 20, agressor.getTankY(), 24, 34);
		} else if (agressor.getDirection().getId() == 2) {
			g.fillRect(agressor.getTankX() + 20, agressor.getTankY() + 30, 24,
					34);
		} else if (agressor.getDirection().getId() == 3) {
			g.fillRect(agressor.getTankX(), agressor.getTankY() + 20, 34, 24);
		} else {
			g.fillRect(agressor.getTankX() + 30, agressor.getTankY() + 20, 34,
					24);
		}
