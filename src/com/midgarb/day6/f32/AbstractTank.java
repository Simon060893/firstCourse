...
public abstract class AbstractTank extends JPanel implements Drawble, Destroyable{
	protected int tankX;
	protected int tankY;
	...
	public void draw(Graphics g){
		...
		if (this.getDirection().getId() == 1) {
			...
			g.fillRect(this.getTankX() + 20, this.getTankY() + 30, 24,
					34);
		} else if (this.getDirection().getId() == 3) {
			g.fillRect(this.getTankX(), this.getTankY() + 20, 34, 24);
		} else {
			g.fillRect(this.getTankX() + 30, this.getTankY() + 20, 34,
					24);
		}
	}
	public void destroy() {
